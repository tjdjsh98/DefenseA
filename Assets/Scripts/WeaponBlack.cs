...
public class WeaponBlack : Weapon
{
    ...
    public override void CompleteReload()
    {
        ...
        else
        {
            ...
            {
                if (_player.BlackSphereList.Count <= 0)
                {
                    _isReload = false;
                    if (_reloadGauge)
                        _reloadGauge.gameObject.SetActive(false);
                ...
                {
                    _reloadingBlackSphere = _player.BlackSphereList[0];
                    _player.BlackSphereList.RemoveAt(0);
    ...
    public override void Reload()
    {
        ...
        if (_player.BlackSphereList.Count <= 0) return;
    ...
    public override void CancelReload()
    {
        ...
        if (_reloadingBlackSphere)
        {
            ...
            _player.BlackSphereList.Add(_reloadingBlackSphere);
        }
    }
}
